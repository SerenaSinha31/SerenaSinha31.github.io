//sharding
// Sharding allows MongoDB to scale horizontally by adding more machines to the cluster, enabling it to handle growing data volumes and user traffic
// Sharding is a concept in MongoDB that splits large data sets into small data sets across multiple MongoDB instances. Sometimes the data within MongoDB will be so huge that queries against such big data sets can cause a lot of CPU utilization on the server.
...
// Connect to Mongo Routing Service
// mongosh --port 27050
